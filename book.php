...
<body style="background-image:url(images/bookback.jpg)">
	<div class="header">
		<ul>
			<li style="float:left;border-right:none"><a href="ulogin.php" class="logo"><img src="cal.jpg" width="30px" height="30px"><strong> Book-A-Slot </strong>Slot Booking System</a></li>
			<li><a href="book.php">Book Now</a></li>
			<li><a href="ulogin.php">Home</a></li>
		</ul>
	</div>
	<form action="book.php" method="post">
	<div class="sucontainer" style="background-image:url(images/business_meeting.jpg)">
		...
		<label style="font-size:20px" >Professor:</label><br>
