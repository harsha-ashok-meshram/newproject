...
<body style="background-image:url(images/cancelback.jpg)">
	<div class="header">
		<ul>
			<li style="float:left;border-right:none"><a href="ulogin.php" class="logo"><img src="cal.png" width="30px" height="30px"><strong> Book-A-Slot</strong></a></li>
			<li><a href="ulogin.php">Home</a></li>
		</ul>
	</div>
	<form action="cancelbookingpatient.php" method="post">
	<div class="sucontainer">
		<label style="font-size:20px" >Select Class to Cancel:</label><br>
		...
		$date= date('Y-m-d');
		$sql1="SELECT * from book where username='".$username."'and status not like 'Cancelled by Professor' and DOV >='$date'";
