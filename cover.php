...
<link rel="stylesheet" href="main.css">
			<div class="header">
				<ul>
					<li style="float:left;border-right:none"><a href="cover.php" class="logo"><img src="cal.jpg" width="30px" height="30px"><strong> Book-A-Slot </strong></a></li>
					<li><a href="aboutus.html">About Us</a></li>
					<li><a href="#home">Home</a></li>
				</ul>
			</div>
			<div class="center">
				<h1>Book-A-Slot</h1><br>
				<p style="text-align:center;color:black;font-size:30px;top:35%">Each meeting occurs at the precise moment for which it was meant. Usually, when it will have the greatest impact on our lives</p><br>
...
<div id="id02" class="modal">
  ...
  <form class="modal-content animate" action="signup.php" method="post">
    ...
    <div class="container">
      ...
      <p style="text-align:center"><b>Booking a slot has never been easier!</b></p>
